...
import { retornarCantVotos, validarSufragio } from "../../services";
      ...
      if (item.principal !== 0) {
        ...
        setResultados((old) => [
          ...old,
          {
            ...
            value: parseInt(votos.votos),
          },
        ]);

        setRepresentantes((old) => [
          ...old,
          {
      ...
      >
        <Stack direction="row" justifyContent="center" spacing={3}>
          ...
          <Autocomplete
            ...
            renderInput={(params) => (
              <TextField {...params} label="Elecciones" />
            )}
            sx={{
              width: "50%",
            }}
        ...
        <Stack direction="column" justifyContent="center" spacing={3}>
          {eleccion !== "" && (
            <FormControl id="agencia">
              <InputLabel id="agencia">Reportes</InputLabel>
              <Select
                labelId="reportes"
                id="reportes"
                label="Reportes"
              ...
              >
                <MenuItem key={1} value={1}>
                  Reporte de resultado de la elección
                </MenuItem>
                <MenuItem key={2} value={2}>
                  Reporte de votantes de la elección
                </MenuItem>
              </Select>
            </FormControl>
          )}
        ...
        {reporte !== 0 && (
          <>
            {descargar === false && (
              <Button variant="contained" onClick={() => setDescargar(true)}>
                Transformar reporte a PDF
              </Button>
            )}
            <CardPastelChart
