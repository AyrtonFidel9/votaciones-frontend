...
export { default as ButtonsCarrusel } from './ButtonsCarrusel';
export { default as LoginTemplate } from './LoginTemplate'; 
export { default as LeftPanelLogin } from './LeftPanelLogin';
export { default as RightPanelLogin } from './RightPanelLogin';